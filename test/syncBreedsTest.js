...
describe('#breedDetails', () => {
  ...
  it('returns undefined when there is no details available for the provided breed', () => {
    const expectedDesc = undefined;
    const maineCoon = breedDetails('Maine Coon');
    assert.equal(expectedDesc, maineCoon);
  });
});